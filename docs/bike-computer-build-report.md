...
| 区域 | 当前占用 | 链接容量 | 余量 |
|---|---:|---:|---:|
| 片上 SRAM 地址范围 | 339,764 bytes | 523,264 bytes | 183,500 bytes |
...
| `bike_service.o` | 1,369 bytes | 3,693 bytes |
| `app_bike.o` | 1,956 bytes | 36 bytes |
| 合计 | 9,624 bytes | 7,594 bytes |
