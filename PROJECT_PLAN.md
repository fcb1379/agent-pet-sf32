...
- Add a list-style launcher using the same registered, functional apps as the icon launcher. Done; double-clicking the physical button while in the launcher toggles between list and icon layouts.
